...
//* "http://192.168.186.88:81/reservationdetail/0/add" urlinin açıldığı doğrulanır.
...
//* "http://192.168.186.88:81/reservationdetail" urlinin açıldığı doğrulanır.
//* Sayfada "Search" butonuna tıklanır.
//* Tabloda "Name" rowunda "Nejdet Arslan" datasının bulunduğu kontrol edilir.
//* Sayfada "Sign Out" butonuna tıklanır.
//* Sign Out pop-up'ının açıldığı kontrol edilir.
//* Sign Out pop-up'ında "OK" ve "Cancel" butonlarının bulunduğu kontrol edilir.
//* Sayfada "OK" butonuna tıklanır.
//* "http://192.168.186.88:81/reservationdetail" urlinin açıldığı doğrulanır.
//* "1" saniye bekle
